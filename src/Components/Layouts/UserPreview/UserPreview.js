  ...
  render() {
    ...
    return (
      <div
        ...
        style={{ borderColor: this.props.client.main_color }}
      >
        <Row>
          ...
          <Col className="actions_container">
            <Row>
              <Col className="button_col">
                <NavLink
                  to={`${this.props.url}/${userData.id}/${this.props.renderView.userinfo}`}
                  title="Ver"
                  style={{
                    color: "white",
                    textDecoration: "none",
            ...
            <Row>
              <Col className="button_col">
                <NavLink
                  to={`${this.props.url}/${userData.id}/${this.props.renderView.insurance}`}
                  title="Ver"
                  style={{
                    color: "white",
                    textDecoration: "none",
            ...
            <Row>
              <Col className="button_col">
                <NavLink
                  to={`${this.props.url}/${userData.id}/${this.props.renderView.treatments}`}
                  title="Ver"
                  style={{
                    color: "white",
                    textDecoration: "none",
